...
interface Props { cameraEnabled: boolean; micEnabled: boolean; isRecording: boolean; isSpeaking: boolean; isProcessing: boolean; costMetrics: CostMetrics; onToggleCamera: () => void; onToggleMic: () => void; onToggleSettings: () => void; onToggleCostMode: () => void; }
  ...
  <div className="flex items-center justify-between px-4 py-2.5 bg-gray-900 border-t border-gray-800">
    ...
    <div className="flex items-center gap-2">
      ...
      <div className="text-xs text-gray-500">
        {costMetrics.requestCount > 0 ? '$' + costMetrics.estimatedCost.toFixed(2) : ''}
      </div>
