...
export const CameraPreview: React.FC<Props> = ({ stream, videoRef, enabled, resolution }) => {
  ...
  return (<div className="bg-gray-900 rounded-xl overflow-hidden aspect-[4/3]">
    {enabled&&stream?(<>
      ...
      <div className="absolute bottom-2 right-2 text-gray-500 text-xs">AI 语音助手</div>
    </>):(<div className="flex items-center justify-center h-full text-gray-500">
      <div className="text-center space-y-2">
        <svg className="w-12 h-12 mx-auto text-gray-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15.75 19.5L8.25 12l7.5-7.5" /></svg>
